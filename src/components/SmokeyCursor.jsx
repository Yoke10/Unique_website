...
export default function SmokeyCursor({
    ...
    `
        ...
        function updateFrame() {
            ...
            // Removed resizeCanvas() polling to avoid forced reflows
        ...
        // Modified to use random Purple/Pinkish colors
        ...
        // Generates colors cycling through brand primary colors
        // Primary Purple: #400763 -> (64, 7, 99)
        // Primary Magenta: #680b56 -> (104, 11, 86) 
        // Primary Pink: #ed0775 -> (237, 7, 117)
        function generateColor() {
            ...
            if (t < 0.5) {
                // Purple to Magenta
                const localT = t * 2;
                r = lerp(64, 104, localT);
                g = lerp(7, 11, localT);
                b = lerp(99, 86, localT);
            } else {
                // Magenta to Pink
                const localT = (t - 0.5) * 2;
                r = lerp(104, 237, localT);
                g = lerp(11, 7, localT);
                b = lerp(86, 117, localT);
            }
        ...
        // Add logic to handle first interaction to start loop (optional but good practice)
        // For React, we'll just start the loop immediately but maybe pause till interaction?
        // The original code did that. Let's keep it simple and just start.
        // Initial resize
        resizeCanvas();
        updateFrame();
